...
const BreakingTicker = ({ posts }: BreakingTickerProps) => {
  ...
  return (
    ...
    >
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 flex items-center h-9">
        <span className="shrink-0 text-[10px] font-bold uppercase tracking-widest text-brand-gold mr-4">
          Latest
        </span>
